...
<template>
    <footer class="footer py-4 mb-xl-0 mb-5">
        <div class="container">
            <div class="row align-items-center gy-3">
                <div class="col-12 col-md-4 text-center text-md-start">
                    <div class="d-flex flex-column gap-1">
                        <a href="tel:+7(385-32)42-8-45" class="text-decoration-none text-dark fw-bold w-100">
                            +7 (385-32) 42-8-45
                        </a>
                        <a href="mailto:school-30@mail.ru" class="text-decoration-none text-muted small w-100">
                            school-30@mail.ru
                        </a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4 text-center text-md-end button-container">
                    <RouterLink to="/admin">
                        <button-primary classes="btn-outline-dark" msg="Войти в систему" />
                    </RouterLink>
                </div>
